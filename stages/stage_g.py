...
{{
  "speech_style": {{
    ...
    "tone_contexts": {{
      "对上级": "语气特点(如:恭敬谦卑，无观测留空)",
      "对平辈": "语气特点(如:随意调侃，无观测留空)",
      "对下级": "语气特点(如:威严冷峻，无观测留空)",
      "对敌人": "语气特点(如:冷酷威胁，无观测留空)"
    }},
  ...
  "behavior_marks": {{
    ...
    "defense_mechanisms": "心理防御机制(如:用幽默掩饰不安，本样本可观测，无观测留空，50字内)",
  ...
  "relationship_dynamics": [
    {{
      ...
      "relationship_timeline": [
        {{
          "chapter_range": "已观测章节范围",
          "relationship_state": "关系状态(如:敌对/合作/暧昧，基于已观测样本)",
...
2. 必须分析人物在不同关系中的语气差异！
3. 必须识别人物的心理防御机制！
4. 如果某个人物信息不足或样本中未观测到，对应字段必须留空，禁止编造
